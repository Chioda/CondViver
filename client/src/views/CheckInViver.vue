            ...
            <tr class="tabela">              
              ...
              <tr class="lado-lado" v-for="agendamento in agendamentos"           
                v-bind:key="agendamento._id" v-show="agendamento.usuario == user.name" >                  
                  ...
                  <td>
                    <button type="button" class="btn btn-danger" @click="deleteAgendamento(agendamento._id)">
                      Remover
                    </button>
                  </td>
                  <td>
                    <button type="button" class="btn btn-success" v-if="agendamento.checkIn == 'Realizado'"  @click="submitUpDateStatus(agendamento)" disabled >
                      Check-In
                    </button>
